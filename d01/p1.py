...
point at 99. Similarly, turning the dial right from 99 one click makes it
point at 0.
...
decoy. The actual password is the number of times the dial is left pointing at
...
def main():
    ...
    with open("input.txt", "r", encoding="utf-8") as f:
        for line in f:
            ...
            match line:
                case turn if turn.startswith("L"):
                    ptr -= int(turn[1:])

                case turn if turn.startswith("R"):
                    ptr += int(turn[1:])
